...
<section class="content col-md-6 col-md-push-3">
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <div class="box box-purple">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-ban"></i> {{$page_title}} Noticia </h3>
                </div><!-- /.box-header -->
                <div class="box-body">
            ...
            <tr>
              ...
              <td>
                {!! Form::open(['route'=>['noticia.destroy',$noticia->id],'method'=>'DELETE']) !!}    {!!Form::button('<i class="fa fa-close"></i> Eliminar Noticia', array('class'=>'btn btn-danger btn-block', 'type'=>'submit')) !!}     
                  {!! Form::close() !!}
              </td>
            </tr>	  			
