    		...
    		@endif
              ...
              <div class="box box-warning">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-pencil text-yellow"></i>SO</h3>

                </div><!-- /.box-header -->
                <!-- form start -->
                <div class="box-body">                
                {!! Form::model($so,['route'=>['plataforma.update_so',$so->id],'method'=>'PUT']) !!}
        			<div class="form-group col-md-12">
                            <label>Nombre del Sistema Operativo</label>
