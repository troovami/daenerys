          ...
          -->
            ...
            <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">SO <small>Total: {{ $total }}</small></h3>
                ...
                <div class="box-body" id="ajax">    
                  ...
                  <table class="table table-bordered table-hover">
                    <tr>
                      ...
                      <th class="text-center" style="width: 35%">Nombre del Sistema Operativo</th>
                      <th class="text-center" style="width: 10%">Estatus</th>
                      <th class="text-center" style="width: 35%">Operaciones</th>
                    </tr>
                    <!--{{$k = 1}}-->
                    @foreach($so as $sistema)                      
                    <tr class="text-center">                   
                    
                    <td style="padding-top:20px;">{{ $k++ }}</td>
                    <td style="padding-top:20px;">{{$sistema->str_descripcion}}</td>                                        
                    @if ($sistema->bol_eliminado == 0)
                      ...
                      <td style="padding-top:15px;">
                        <div class="btn-group">
                                <a class="btn btn-warning btn-flat" href="{{route('plataforma.edit_so',$sistema->id)}}" title="Editar"><i class="fa fa-pencil"></i></a>
                                <a class="btn btn-info btn-flat" href="{{route('plataforma.show_so',$sistema->id)}}" title="Consultar"><i class="fa fa-search"></i></a>
                                <a class="btn bg-purple btn-flat" href="{{route('plataforma.status_so',$sistema->id)}}" title="Cambiar Status (Activar / Desactivar)"><i class="fa fa-ban"></i></a>     
                                <a class="btn btn-danger btn-flat" href="{{route('plataforma.delete_so',$sistema->id)}}" title="Eliminar"><i class="fa fa-close"></i></a>
