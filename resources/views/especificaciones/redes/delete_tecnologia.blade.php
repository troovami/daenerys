          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="box box-purple">
                ...
                <div class="box-body">
                  <table class="table table-bordered">Tecnología
                  	<tbody>
		  			<tr>
            ...
            <tr>
              ...
              <td>
                {!! Form::open(['route'=>['redes.destroy_tecnologia',$tecnologia->id],'method'=>'DELETE']) !!}    {!!Form::button('<i class="fa fa-close"></i> Eliminar Tecnología', array('class'=>'btn btn-danger btn-block', 'type'=>'submit')) !!}     
                  {!! Form::close() !!}
              </td>
            </tr>	  			
