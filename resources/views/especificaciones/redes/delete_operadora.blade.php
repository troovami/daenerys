...
<section class="content col-md-6 col-md-push-3">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="box box-purple">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-ban"></i>Operadora</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table class="table table-bordered">Operadora
                  	<tbody>
		  			<tr>
            ...
            <tr>
              ...
              <td>
                {!! Form::open(['route'=>['redes.destroy_operadora',$operadora->id],'method'=>'DELETE']) !!}    {!!Form::button('<i class="fa fa-close"></i> Eliminar Operadora', array('class'=>'btn btn-danger btn-block', 'type'=>'submit')) !!}     
                  {!! Form::close() !!}
              </td>
            </tr>	  			
