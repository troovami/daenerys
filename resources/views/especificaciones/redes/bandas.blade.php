          ...
          -->
            ...
            <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Bandas <small>Total: {{ $total }}</small></h3>
                ...
                <div class="box-body" id="ajax">    
                  ...
                  <table class="table table-bordered table-hover">
                    <tr>
                      ...
                      <th class="text-center" style="width: 35%">Frecuencia de la Banda</th>
                    ...
                    <td style="padding-top:20px;">{{$banda->str_frecuecia}}</td>                                        
                    @if ($banda->bol_eliminado == 0)
                      ...
                      <td style="padding-top:15px;">
                        <div class="btn-group">
                                ...
                                <a class="btn btn-info btn-flat" href="{{route('redes.show_banda',$banda->id)}}" title="Consultar"><i class="fa fa-search"></i></a>
