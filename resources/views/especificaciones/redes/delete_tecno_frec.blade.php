...
<section class="content col-md-6 col-md-push-3">
          ...
          <div class="row">
          	<div class="col-md-6">
  			     <h2 class="text-center">&laquo; {{$tecnologia_full}} &raquo;</h2>
  			</div>
            <div class="col-md-6">
              <div class="box box-purple">
                <div class="box-body">
                  <table class="table table-bordered">
                  	<tbody>
            <th class="text-right">Tecnologia:</th>
            ...
            <tr>
              ...
              <td>
                {!! Form::open(['route'=>['redes.destroy_tecno_frec',$tecno_frec->id],'method'=>'DELETE']) !!}    {!!Form::button('<i class="fa fa-close"></i> Eliminar', array('class'=>'btn btn-danger btn-block', 'type'=>'submit')) !!}     
                  {!! Form::close() !!}
              </td>
            </tr>	  			
