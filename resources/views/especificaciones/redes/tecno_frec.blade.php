          ...
          -->
            ...
            <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Tecnología- Frecuencia<small>Total: {{ $total }}</small></h3>
                ...
                <div class="box-body" id="ajax">    
                  ...
                  <table class="table table-bordered table-hover">
                    <tr>
                      ...
                      <th class="text-center" style="width: 20%">Frecuencia</th>
                      <th class="text-center" style="width: 10%">Estatus</th>
                      <th class="text-center" style="width: 35%">Operaciones</th>
                    </tr>
                    <!--{{$k = 1}}-->
                    @foreach($tecno_frec as $tf)                      
                    <tr class="text-center">                   
                    
                    <td style="padding-top:20px;">{{ $k++ }}</td>
                    <td style="padding-top:20px;">{{$tf->tecnologia_full}}</td>
                    <td style="padding-top:20px;">{{$tf->str_frecuecia}}</td>                                        
                    @if ($tf->bol_eliminado == 0)
                      ...
                      <td style="padding-top:15px;">
                        <div class="btn-group">
                                <!--<a class="btn btn-warning btn-flat" href="{{route('redes.edit_tecno_frec',$tf->id)}}" title="Editar"><i class="fa fa-pencil"></i></a>
                                <a class="btn btn-info btn-flat" href="{{route('redes.show_tecnologia',$tf->id)}}" title="Consultar"><i class="fa fa-search"></i></a>
                                <a class="btn bg-purple btn-flat" href="{{route('redes.status_tecnologia',$tf->id)}}" title="Cambiar Status (Activar / Desactivar)"><i class="fa fa-ban"></i></a>-->  
                                <a class="btn btn-danger btn-flat" href="{{route('redes.delete_tecno_frec',$tf->id)}}" title="Eliminar"><i class="fa fa-close"></i></a>
