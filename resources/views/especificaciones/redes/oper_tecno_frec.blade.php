          ...
          -->
            ...
            <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Operadora Tecnología Frecuencia<small>Total: {{ $total }}</small></h3>
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    @if ($otf->bol_eliminado == 0)
                      ...
                      <td style="padding-top:15px;">
                        <div class="btn-group">
                                <!--<a class="btn btn-warning btn-flat" href="{{route('redes.edit_oper_tecno_frec',$otf->id)}}" title="Editar"><i class="fa fa-pencil"></i></a>
                                <a class="btn btn-info btn-flat" href="{{route('redes.show_tecnologia',$otf->id)}}" title="Consultar"><i class="fa fa-search"></i></a>
                                <a class="btn bg-purple btn-flat" href="{{route('redes.status_tecnologia',$otf->id)}}" title="Cambiar Status (Activar / Desactivar)"><i class="fa fa-ban"></i></a>-->  
                                <a class="btn btn-danger btn-flat" href="{{route('redes.delete_oper_tecno_frec',$otf->id)}}" title="Eliminar"><i class="fa fa-close"></i></a>
