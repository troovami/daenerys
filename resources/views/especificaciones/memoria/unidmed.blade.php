...
@section('padre', 'Unidad de Medida')
	@section('head')
	<!-- DATA TABLES -->
          ...
          -->
            ...
            <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Unidad de Medida <small>Total: {{ $total }}</small></h3>
                ...
                <div class="box-body" id="ajax">    
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <!--{{$k = 1}}-->
                    @foreach($um as $unidmed)                      
                    <tr class="text-center">                   
                    
                    <td style="padding-top:20px;">{{ $k++ }}</td>
                    <td style="padding-top:20px;">{{$unidmed->str_descripcion}}</td>                                        
                    @if ($unidmed->bol_eliminado == 0)
                      ...
                      <td style="padding-top:15px;">
                        <div class="btn-group">
                                <a class="btn btn-warning btn-flat" href="{{route('bateria.edit_unidmed',$unidmed->id)}}" title="Editar"><i class="fa fa-pencil"></i></a>
                                <a class="btn btn-info btn-flat" href="{{route('bateria.show_unidmed',$unidmed->id)}}" title="Consultar"><i class="fa fa-search"></i></a>
                                <a class="btn bg-purple btn-flat" href="{{route('bateria.status_unidmed',$unidmed->id)}}" title="Cambiar Status (Activar / Desactivar)"><i class="fa fa-ban"></i></a>     
                                <a class="btn btn-danger btn-flat" href="{{route('bateria.delete_unidmed',$unidmed->id)}}" title="Eliminar"><i class="fa fa-close"></i></a>
