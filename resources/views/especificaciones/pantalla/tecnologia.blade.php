          ...
          -->
            ...
            <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Tecnología <small>Total: {{ $total }}</small></h3>
                ...
                <div class="box-body" id="ajax">    
                  ...
                  <table class="table table-bordered table-hover">
                    <tr>
                      ...
                      <th class="text-center" style="width: 35%">Nombre de la Tecnología</th>
                    ...
                    <td style="padding-top:20px;">{{$tecno->str_descripcion}}</td>                                        
                    @if ($tecno->bol_eliminado == 0)
                      ...
                      <td style="padding-top:15px;">
                        <div class="btn-group">
                                <a class="btn btn-warning btn-flat" href="{{route('pantalla.edit_tecnologia',$tecno->id)}}" title="Editar"><i class="fa fa-pencil"></i></a>
                                <a class="btn btn-info btn-flat" href="{{route('pantalla.show_tecnologia',$tecno->id)}}" title="Consultar"><i class="fa fa-search"></i></a>
                                <a class="btn bg-purple btn-flat" href="{{route('pantalla.status_tecnologia',$tecno->id)}}" title="Cambiar Status (Activar / Desactivar)"><i class="fa fa-ban"></i></a>     
                                <a class="btn btn-danger btn-flat" href="{{route('pantalla.delete_tecnologia',$tecno->id)}}" title="Eliminar"><i class="fa fa-close"></i></a>
