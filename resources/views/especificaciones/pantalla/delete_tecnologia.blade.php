...
<section class="content col-md-6 col-md-push-3">
          ...
          <div class="row">
              ...
              <div class="box box-purple">
                ...
                <div class="box-body">
                  <table class="table table-bordered">
                  	<tbody>
		  			<tr>
            <th class="text-right">Nombre de la Tecnología:</th>
            ...
            <tr>
              ...
              <td>
                {!! Form::open(['route'=>['pantalla.destroy_tecnologia',$tecnologia->id],'method'=>'DELETE']) !!}    {!!Form::button('<i class="fa fa-close"></i> Eliminar Tecnología', array('class'=>'btn btn-danger btn-block', 'type'=>'submit')) !!}     
                  {!! Form::close() !!}
              </td>
            </tr>	  			
