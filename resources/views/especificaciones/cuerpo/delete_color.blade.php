        ...
        @endif
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="box box-purple">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-ban"></i>Color</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
            ...
            <tr>
              ...
              <td>
                {!! Form::open(['route'=>['cuerpo.destroy_color',$color->id],'method'=>'DELETE']) !!}    {!!Form::button('<i class="fa fa-close"></i> Eliminar Color', array('class'=>'btn btn-danger btn-block', 'type'=>'submit')) !!}     
                  {!! Form::close() !!}
              </td>
            </tr>         
