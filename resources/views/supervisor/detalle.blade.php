                ...
                <ul class="nav nav-tabs pull-right">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="{{route('supervisor.activar',$idVehiculo)}}">Activar</a></li>
                      <li role="presentation"><a role="menuitem" tabindex="-1" href="{{route('supervisor.desactivar',$idVehiculo)}}">No Activar</a></li>
                    </ul>
                  </li>   
