...
<html>
  <head>
    ...
    {!! Html::style('admin-lte/plugins/iCheck/all.css') !!}    
    <!-- Bootstrap Color Picker -->
    {!! Html::style('admin-lte/plugins/colorpicker/bootstrap-colorpicker.min.css') !!}    
    <!-- Bootstrap time Picker -->
    {!! Html::style('admin-lte/plugins/timepicker/bootstrap-timepicker.min.css') !!}    
    <!-- Select2 -->
  ...
  <body class="skin-blue sidebar-mini">
    ...
    <!-- InputMask -->
    {!! Html::script('admin-lte/plugins/input-mask/jquery.inputmask.js') !!}
    {!! Html::script('admin-lte/plugins/input-mask/jquery.inputmask.date.extensions.js') !!}
    {!! Html::script('admin-lte/plugins/input-mask/jquery.inputmask.extensions.js') !!}
    <!-- date-range-picker -->
    ...
    <!-- bootstrap color picker -->
    {!! Html::script('admin-lte/plugins/colorpicker/bootstrap-colorpicker.min.js') !!}
    <!-- bootstrap time picker -->
    {!! Html::script('admin-lte/plugins/timepicker/bootstrap-timepicker.min.js') !!}
    <!-- SlimScroll 1.3.0 -->
