        ...
        @endif
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><i class="text-light-blue"></i> All Marcas</h3>

                </div><!-- /.box-header -->
                <div class="box-body">
                <p><i class=""></i> Total de Marcas: <b>{{count($marcas)}}</b></p>
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr>                        
                        <th class="text-center"><i class=""></i> #</th>
                        <th class="text-center col-md-2"><i class=""></i> Logo</th>
