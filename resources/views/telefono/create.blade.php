						...
						<div class="form-group col-md-12">
						      ...
						      <div id="cuerpo" class="panel-collapse collapse">
							       	<div class="panel-body">
							       		<div class="form-group col-md-4">
							            	...
							            	{!! Form::input('text', 'str_descripcion[]', '', ['id' => 'str_descripcion[]', 'class'=> 'form-control','required','placeholder'=>'150 mm','data-inputmask'=>'999 AA']) !!}
							            </div>
							       		<div class="form-group col-md-4">
							       			<label>Ancho</label>
										...
										<div class="form-group col-md-12">
							       			<label>Color</label>
							       			<input type="hidden" name="str_titulo_color[]" value="Color">
									        ...
									        @foreach ($color as $colors)
									           	<tr>
												    ...
												    <td style="padding-bottom: 25px;"><input class="" name="str_color[]" id ="str_color[]" type="checkbox" value="{{$colors->nombre_color}}"></td>
												</tr>
										    @endforeach
										    </table>
							       		</div>
								...
								<div id="memoria" class="panel-collapse collapse">
									<div class="panel-body">
										...
										<div class="form-group col-md-6">
											...
											{!! Form::input('text', 'str_descripcion[]', '', ['id' => 'str_descripcion[]', 'class'=> 'form-control simple-field-data-mask','required','placeholder'=>'256','data-mask'=>"000"]) !!}
										</div>
										<div class="form-group col-md-6">
								...
								<div id="sonido" class="panel-collapse collapse">
									<div class="panel-body">
										<div class="form-group col-md-12">
											...
											{!! Form::input('text', '', '', ['id' => '', 'class'=> 'form-control','required']) !!}
										</div>
										<div class="form-group col-md-12">
										...
										<div class="form-group col-md-12">
											...
											{!! Form::textarea('text', 'str_descripcion[]', ['id' => 'str_descripcion[]', 'class'=> 'form-control','required']) !!}
										</div>
									</div>  
								</div>
							</div>
								...
								<div id="conectividad" class="panel-collapse collapse">
									<div class="panel-body">
										...
										<div class="form-group col-md-12">
											...
											{!! Form::textarea('str_descripcion[]', '', ['id' => 'str_descripcion[]', 'class'=> 'form-control','required']) !!}
										</div>
									</div>  
								</div>
							</div>
							...
							<div class="panel panel-default">
								...
								<div id="caracteristicas" class="panel-collapse collapse">
									<div class="panel-body">
										<div class="form-group col-md-12">
											<label>Sensores</label><br>
											<input type="hidden" name="str_titulo[]" value="Sensores">                            
										</div>
										<div class="form-group col-md-12">
											<label>Mensajeria</label> 
											<input type="hidden" name="str_titulo[]" value="Mensajeria">  
											{!! Form::input('text', 'str_descripcion[]', '', ['id' => 'str_descripcion[]', 'class'=> 'form-control','required','placeholder'=>'SMS, MMS, Correo Electrónico']) !!}
										</div>
										<div class="form-group col-md-12">
