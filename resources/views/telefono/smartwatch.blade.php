        ...
        @endif
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><i class="text-light-blue"></i> All Smartwatch</h3>

                </div><!-- /.box-header -->
                <div class="box-body">
                <p><i class=""></i> Total de Smartwatch: <b>{{count($smartwatch)}}</b></p>
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody> 
                     <!--{{$k = 1}}-->                   
                      @foreach($smartwatch as $smart)                      
                    <tr class="text-center">                   
                    <td style="padding-top:20px;">{{ $k++ }}</td>
                    <td style="padding-top:20px;">{{$smart->marca}}</td>
                    <td style="padding-top:20px;">{{$smart->modelo}}</td>  
                    <td style="padding-top:20px;">{{$smart->version}}</td>                                          
                    @if ($smart->bol_eliminado == 0)
                    ...
                    <td>
                        <div class="btn-group">
                                <a class="btn btn-info btn-flat" href="{{route('telefono.show',$smart->id)}}" title="Consultar"><i class="fa fa-search"></i></a>
                                <a class="btn btn-danger btn-flat" href="{{route('telefono.delete',$smart->id)}}" title="Eliminar"><i class="fa fa-close"></i></a>
                        </div>
                    </td> 
